...
if(WITH_ASCEND_CL)
    ...
    if(WITH_ECCL STREQUAL WITH_HCCL)
        message(FATAL_ERROR "Paddle only/must have one of [hccl or eccl] in ascend platform!")
    elseif(WITH_ECCL)
        add_definitions(-DPADDLE_WITH_ECCL)
        message(STATUS "Paddle run with eccl in ascend platform!")
    elseif(WITH_HCCL)
        add_definitions(-DPADDLE_WITH_HCCL)
        message(STATUS "Paddle run with hccl in ascend platform!")
    endif()
endif()
